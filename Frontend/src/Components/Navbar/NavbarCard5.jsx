              ...
              <Grid gridTemplateColumns="repeat(5, 1fr)" w="100%">
                <Flex direction="column" justifyContent="space-evenly" mt="20">
                  ...
                  <Flex gap="5">
                    <Avatar
                      name="Rashi Mall"
                      src="https://imgur.com/IR1Iyh7.png"
                      alt="women"
                      size="md"
                    />
                    <Box
                  ...
                  <Flex gap="5">
                    <Avatar
                      name="Anmol Gupta"
                      src="https://imgur.com/TxWcFVI.png"
                      alt="Funky"
                      size="md"
                    />
                    <Box
                  ...
                  <Flex gap="5">
                    <Avatar
                      name="Arpitkumar Mishra"
                      src="https://imgur.com/NwA3LJD.png"
                      alt="kid"
                      size="md"
                    />
                    <Box
              ...
              <Grid gridTemplateColumns="repeat(5, 1fr)" w="100%">
                ...
                >
                  ...
                  <Flex gap="5">
                    <Avatar
                      name="Rashi Mall"
                      src="https://imgur.com/hbzeIqv.png"
                      alt="women"
                      size="md"
                    />
                    <Box
            ...
            <Grid gridTemplateColumns="repeat(2, 1fr)">
              ...
              <Box>
                <Box m="auto">
                  ...
                  <a href="https://www.lenskart.com/HTO/">
                  <Button
                    colorScheme="black"
                    variant="outline"
                    bg="whiteAlpha.900"
        ...
        >
          <Grid gridTemplateColumns="repeat(2, 1fr)">
            <Box>
              ...
              <a href="https://www.lenskart.com/stores">
               <Button
                colorScheme="black"
                variant="outline"
                bg="whiteAlpha.900"
            ...
            <Flex mt="30%" fontSize="14px" fontWeight="600">
             <a href="https://www.lenskart.com/stores/location/delhi">
              <Box>
                <Image
                  h=""
                  w=""
              ...
              <a href="https://www.lenskart.com/stores/location/karnataka/bengaluru">
              <Box>
                <Image
                  h=""
                  w=""
              ...
              <a href="https://www.lenskart.com/stores/location/maharashtra/mumbai">
              <Box>
                <Image
                  h=""
                  w=""
              ...
              <a href="https://www.lenskart.com/stores/location/gujarat/ahmedabad">
              <Box>
                <Image
                  h=""
                  w=""
              ...
              <a href="https://www.lenskart.com/stores/location/chennai">
              <Box>
                <Image
                  h=""
                  w=""
              ...
              <a href="https://www.lenskart.com/stores/location/telangana/hyderabad">
              <Box>
                <Image
                  h=""
                  w=""
